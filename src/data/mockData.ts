...
export const marketStocks: Stock[] = [
  ...
  // Additional high-yield candidates
  {
    ticker: 'BP',
    name: 'BP p.l.c.',
    sector: 'Energy',
    currentPrice: 38.00,
    annualDividend: 1.98,
    dividendHistory: generateDividendHistory(0.494, 5, 'stable'),
    currentYield: 5.21,
  },
  {
    ticker: 'BTI',
    ...
    currentPrice: 38.50,
    annualDividend: 2.92,
    dividendHistory: generateDividendHistory(0.73, 5, 'stable'),
    currentYield: 7.58,
  },
  {
    ticker: 'ENB',
    ...
    currentPrice: 44.00,
    annualDividend: 2.76,
    dividendHistory: generateDividendHistory(0.69, 5, 'growing'),
    currentYield: 6.27,
  },
  {
    ticker: 'HESM',
    name: 'Hess Midstream Partners',
    sector: 'Energy',
    currentPrice: 38.00,
    annualDividend: 2.56,
    dividendHistory: generateDividendHistory(0.64, 5, 'growing'),
    currentYield: 6.74,
  },
  {
    ticker: 'ET',
    ...
    currentPrice: 19.00,
    annualDividend: 1.27,
    dividendHistory: generateDividendHistory(0.32, 5, 'growing'),
    currentYield: 6.68,
  },
  {
    ticker: 'MPLX',
    ...
    currentPrice: 48.00,
    annualDividend: 3.58,
    dividendHistory: generateDividendHistory(0.895, 5, 'growing'),
    currentYield: 7.46,
  },
  {
    ticker: 'ARCC',
    ...
    currentPrice: 22.00,
    annualDividend: 1.92,
    dividendHistory: generateDividendHistory(0.48, 5, 'stable'),
    currentYield: 8.73,
  },
  {
    ticker: 'WBA',
    ...
    currentPrice: 12.00,
    annualDividend: 1.00,
    dividendHistory: generateDividendHistory(0.25, 5, 'declining'),
    currentYield: 8.33,
  },
  {
    ticker: 'IRM',
    ...
    currentPrice: 85.00,
    annualDividend: 5.24,
    dividendHistory: generateDividendHistory(1.31, 5, 'growing'),
    currentYield: 6.16,
  },
];
