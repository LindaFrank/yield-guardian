        ...
        <div className="container mx-auto px-6 py-5 relative">
          ...
          {!user && (
            <div className="flex justify-center mt-4">
              <Button
                size="default"
                className="gap-2 bg-[#147a8a] hover:bg-[#1a8fa3] text-white border-[5px] border-amber-600 shadow-glow px-[43px] py-[31px] text-[18px] font-semibold h-auto min-h-fit rounded-lg"
                onClick={() => {
