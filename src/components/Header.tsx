        ...
        <div className="container mx-auto px-6 py-5 relative">
          ...
          {!user && (
            <div className="flex justify-center mt-4">
              <Button
                size="default"
                className="gap-2 bg-primary hover:bg-primary/90 text-white border-2 border-primary/40 px-[43px] py-[31px] text-[18px] font-semibold h-auto min-h-fit rounded-lg transition-all duration-300"
                onClick={() => {
