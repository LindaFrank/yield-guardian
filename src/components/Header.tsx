            ...
            <div className={`flex flex-col items-end gap-2 ${!user ? '-mt-[170px]' : '-mt-[15px]'}`}>
              {showBackButton && !!user && (
                <Button
                  ...
                  onClick={handleBack}
                  title="Go back"
                  className="mt-1 min-w-[97px] text-[#07433a] hover:text-[#052f2a] hover:bg-[#07433a]/10 gap-1.5"
                >
          ...
          {!user && (
            <div className="absolute top-1 right-4 z-[55] flex flex-col items-center gap-2">
              <Button
                ...
                title="Go back"
                className="bg-[#0a0a0a] border-gray-500 text-[#07433a] hover:bg-[#141414] hover:border-gray-400 hover:text-[#052f2a] gap-1.5 font-semibold"
              >
                <ArrowLeft className="w-4 h-4" />
                <span className="hidden sm:inline">Back</span>
              </Button>
