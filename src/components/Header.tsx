            ...
            <div className={`flex flex-col items-end gap-2 ${!user ? '-mt-[170px]' : '-mt-[15px]'}`}>
              {showBackButton && !!user && (
                <Button
                  ...
                  onClick={handleBack}
                  title="Go back"
                  className="mt-1 min-w-[97px] text-[#0b4f5c] hover:text-[#0d5c6b] hover:bg-[#0b4f5c]/10 gap-1.5"
                >
          ...
          {!user && (
            <div className="absolute top-1 right-4 z-[55] flex flex-col items-center gap-2">
              <Button
                ...
                title="Go back"
                className="bg-[#050505] border-gray-400 text-[#0b4f5c] hover:bg-[#0a0a0a] hover:border-gray-300 hover:text-[#0d5c6b] gap-1.5 font-semibold"
              >
                <ArrowLeft className="w-4 h-4" />
                <span className="hidden sm:inline">Back</span>
              </Button>
