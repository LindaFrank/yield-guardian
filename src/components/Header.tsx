      ...
      <header className="bg-card/50 backdrop-blur-sm sticky top-0 z-50">
        <div className="container mx-auto px-6 py-5 relative">
          ...
          {!user && (
            <Button
              size="default"
              className="absolute top-4 left-4 z-[55] gap-2 bg-[#147a8a] hover:bg-[#1a8fa3] text-white border-[5px] border-amber-600 shadow-glow px-[43px] py-[31px] text-[18px] font-semibold h-auto min-h-fit rounded-lg"
              onClick={() => {
