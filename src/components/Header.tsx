        ...
        <div className="container mx-auto px-6 py-5 relative">
          ...
          {!user && (
            <div className="flex justify-center mt-4">
              <Button
                size="default"
                className="gap-2 bg-[#147a8a] hover:bg-[#1a8fa3] text-white border-[10px] border-amber-600 shadow-glow px-[38px] py-[26px] text-sm font-semibold h-auto min-h-fit rounded-full"
                onClick={() => {
