...
export function UnderperformersList({ 
  ...
  return (
    <div className="p-5 rounded-xl gradient-card shadow-card border-[4px] border-red-500/70 transition-all duration-200 hover:scale-[1.01] hover:-translate-y-1 active:scale-[0.98]">
