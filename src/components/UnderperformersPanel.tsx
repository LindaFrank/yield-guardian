            ...
            {selectedStock ? (
              <div className="relative">
                <button
                  ...
                  className="absolute top-[calc(0.5rem+1%+0.03%)] right-[calc(0.5rem+1%)] z-10 w-6 h-6 flex items-center justify-center rounded-md border-[2px] border-muted-foreground/50 bg-secondary/80 backdrop-blur text-muted-foreground hover:text-foreground hover:border-muted-foreground/80 hover:bg-secondary transition-colors"
                >
