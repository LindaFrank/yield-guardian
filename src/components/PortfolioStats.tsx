  ...
  return (
    <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
      {stats.map((stat) => {
        ...
        const card = (
          <div
            className="p-4 rounded-xl gradient-card shadow-card border-[4px] border-muted-foreground/50 transition-all hover:border-muted-foreground/60 hover:scale-[1.02] active:scale-[0.97]"
          >
