    ...
    <div className="min-h-screen bg-background relative overflow-hidden">
      ...
      <div className="relative z-10 min-h-screen flex flex-col items-center justify-center px-4 py-10">
        <motion.div className="flex flex-col items-center" animate={{ marginBottom: showForm ? 24 : 0 }} transition={{ duration: 0.8, ease: [0.22, 1, 0.36, 1] }}>
          <motion.div className="relative mb-6 mt-2.5" initial={{ scale: 0, rotate: -180 }} animate={{ scale: showForm ? 0.8 : 1, rotate: 0 }} transition={{ type: 'spring', stiffness: 200, damping: 20 }}>
