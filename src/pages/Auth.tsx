    ...
    <div className="min-h-screen bg-background relative overflow-hidden">
      ...
      <div className="relative z-10 min-h-screen flex flex-col items-center justify-center px-4 py-4">
        <motion.div className="flex flex-col items-center" animate={{ marginBottom: showForm ? 12 : 0 }} transition={{ duration: 0.8, ease: [0.22, 1, 0.36, 1] }}>
          ...
          <motion.h1 className="text-[38px] font-bold tracking-tight mb-2" initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.3, duration: 0.6 }}>
              ...
              <div className="relative gradient-card rounded-xl border border-muted-foreground/50 shadow-elevated backdrop-blur-sm p-4">
                ...
                <form onSubmit={handleSubmit} className="space-y-2">
                  ...
                  <div className="space-y-1.5">
                    ...
                    <Input type="email" value={email} onChange={(e) => setEmail(e.target.value)} required maxLength={255} placeholder="you@example.com" className="border-2 border-muted-foreground/70 bg-card/50" />
                  </div>
                  {mode !== 'forgot' && (
                    <div className="space-y-1.5">
